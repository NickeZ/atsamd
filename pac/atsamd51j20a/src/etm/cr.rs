...
#[doc = r" Proxy"]
pub struct _PORTMODE2W<'a> {
    w: &'a mut W,
}
impl<'a> _PORTMODE2W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _PORTSIZE3W<'a> {
    w: &'a mut W,
}
impl<'a> _PORTSIZE3W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bits 4:6 - Port Size bits 2:0"]
    #[inline]
    pub fn portsize(&mut self) -> _PORTSIZEW {
        _PORTSIZEW { w: self }
    }
    #[doc = "Bit 7 - Stall Processor"]
    #[inline]
    ...
    #[doc = "Bit 8 - Branch Output"]
    #[inline]
    pub fn brout(&mut self) -> _BROUTW {
        _BROUTW { w: self }
    }
    #[doc = "Bit 9 - Debug Request Control"]
    #[inline]
    pub fn dbgrq(&mut self) -> _DBGRQW {
        _DBGRQW { w: self }
    }
    #[doc = "Bit 10 - ETM Programming"]
    #[inline]
    ...
    #[doc = "Bit 11 - ETM Port Select"]
    #[inline]
    pub fn portsel(&mut self) -> _PORTSELW {
        _PORTSELW { w: self }
    }
    #[doc = "Bit 13 - Port Mode bit 2"]
    #[inline]
    pub fn portmode2(&mut self) -> _PORTMODE2W {
        _PORTMODE2W { w: self }
    }
    #[doc = "Bits 16:17 - Port Mode bits 1:0"]
    #[inline]
    pub fn portmode(&mut self) -> _PORTMODEW {
        _PORTMODEW { w: self }
    }
    #[doc = "Bit 21 - Port Size bit 3"]
    #[inline]
    pub fn portsize3(&mut self) -> _PORTSIZE3W {
        _PORTSIZE3W { w: self }
    }
    #[doc = "Bit 28 - TimeStamp Enable"]
    #[inline]
