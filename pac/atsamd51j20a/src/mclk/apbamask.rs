...
#[doc = r" Proxy"]
pub struct _OSC32KCTRL_W<'a> {
    w: &'a mut W,
}
impl<'a> _OSC32KCTRL_W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - MCLK APB Clock Enable"]
    #[inline]
    pub fn mclk_(&mut self) -> _MCLK_W {
        _MCLK_W { w: self }
    }
    #[doc = "Bit 3 - RSTC APB Clock Enable"]
    #[inline]
    pub fn rstc_(&mut self) -> _RSTC_W {
        _RSTC_W { w: self }
    }
    #[doc = "Bit 4 - OSCCTRL APB Clock Enable"]
    #[inline]
    pub fn oscctrl_(&mut self) -> _OSCCTRL_W {
        _OSCCTRL_W { w: self }
    }
    #[doc = "Bit 5 - OSC32KCTRL APB Clock Enable"]
    #[inline]
    pub fn osc32kctrl_(&mut self) -> _OSC32KCTRL_W {
        _OSC32KCTRL_W { w: self }
    }
    #[doc = "Bit 6 - SUPC APB Clock Enable"]
    #[inline]
    pub fn supc_(&mut self) -> _SUPC_W {
        _SUPC_W { w: self }
    }
    #[doc = "Bit 7 - GCLK APB Clock Enable"]
    #[inline]
    pub fn gclk_(&mut self) -> _GCLK_W {
        _GCLK_W { w: self }
    }
    #[doc = "Bit 8 - WDT APB Clock Enable"]
    #[inline]
