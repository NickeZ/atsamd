...
impl W {
    ...
    #[doc = "Bit 8 - Link Power Management Not Yet Interrupt Enable"]
    #[inline]
    pub fn lpmnyet(&mut self) -> _LPMNYETW {
        _LPMNYETW { w: self }
    }
    #[doc = "Bit 9 - Link Power Management Suspend Interrupt Enable"]
    #[inline]
    pub fn lpmsusp(&mut self) -> _LPMSUSPW {
        _LPMSUSPW { w: self }
    }
}
