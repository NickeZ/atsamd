...
#[doc = r" Value of the field"]
pub struct NVMCTRL_SMEEPROM_R {
    bits: bool,
}
impl NVMCTRL_SMEEPROM_R {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct NVMCTRL_CACHE_R {
    bits: bool,
}
impl NVMCTRL_CACHE_R {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Proxy"]
pub struct _NVMCTRL_SMEEPROM_W<'a> {
    w: &'a mut W,
}
impl<'a> _NVMCTRL_SMEEPROM_W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _NVMCTRL_CACHE_W<'a> {
    w: &'a mut W,
}
impl<'a> _NVMCTRL_CACHE_W<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 7 - HSRAM AHB Clock Mask"]
    #[inline]
    pub fn hsram_(&mut self) -> _HSRAM_W {
        _HSRAM_W { w: self }
    }
    #[doc = "Bit 8 - CMCC AHB Clock Mask"]
    #[inline]
    ...
    #[doc = "Bit 21 - QSPI_2X AHB Clock Mask"]
    #[inline]
    pub fn qspi_2x_(&mut self) -> _QSPI_2X_W {
        _QSPI_2X_W { w: self }
    }
    #[doc = "Bit 22 - NVMCTRL_SMEEPROM AHB Clock Mask"]
    #[inline]
    pub fn nvmctrl_smeeprom_(&mut self) -> _NVMCTRL_SMEEPROM_W {
        _NVMCTRL_SMEEPROM_W { w: self }
    }
    #[doc = "Bit 23 - NVMCTRL_CACHE AHB Clock Mask"]
    #[inline]
    pub fn nvmctrl_cache_(&mut self) -> _NVMCTRL_CACHE_W {
        _NVMCTRL_CACHE_W { w: self }
    }
}
